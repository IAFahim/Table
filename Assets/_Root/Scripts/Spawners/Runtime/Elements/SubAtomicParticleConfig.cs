...
namespace _Root.Scripts.Spawners.Runtime.Elements
{
    ...
    {
        [FormerlySerializedAs("particleCount")] [SerializeField] public int particleRemaining;
        public Vector2 delayForParticle;
        [SerializeField] private float particleWaitingTime;
        [SerializeField] private bool particleSpawned;
